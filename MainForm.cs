...
namespace WY_App
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            dataGridView1.Rows[1].Cells[0].Value = "总宽";
            dataGridView1.Rows[2].Cells[0].Value = "总长";
            dataGridView1.Rows[3].Cells[0].Value = "料宽";
            dataGridView1.Rows[4].Cells[0].Value = "胶宽";
            dataGridView1.Rows[5].Cells[0].Value = "长端";

            dataGridView1.Rows[6].Cells[0].Value = "短端";
            dataGridView1.Rows[7].Cells[0].Value = "右肩高";
            dataGridView1.Rows[8].Cells[0].Value = "右肩宽";
            dataGridView1.Rows[9].Cells[0].Value = "左肩高";
            dataGridView1.Rows[10].Cells[0].Value ="左肩宽";

            dataGridView1.Rows[11].Cells[0].Value = "气泡";
            dataGridView1.Rows[12].Cells[0].Value = "黑点";
            dataGridView1.Rows[13].Cells[0].Value = "刺伤";
            dataGridView1.Rows[14].Cells[0].Value = "划伤";
            dataGridView1.Rows[15].Cells[0].Value = "压痕";
            for (int i = 0; i < 5; i++)
            {
                dataGridView1.Rows[i + 11].Cells[1].Value = count[i];
            }
        ...
        private void MainRun()
        {
            while (true)
            {
                ...
                {                    
                    ...
                    if ( detectioresult.Length > 5)
                    {
                        ...
                        if (value != null)
                        {
                            for (int j = 0; j < 10; j++)
                            {
                                dataGridView1.Rows[j + 1].Cells[1].Value = value[j + 8];
                            }
                            for (int j = 0; j < 5; j++)
                            {
                                if (value[j+3] != 0.001)
                                {
                                    count[j]++;
                                    dataGridView1.Rows[j + 11].Cells[1].Value = count[j];
                                }
                            }
                        }
                        Thread.Sleep(500);
                ...
                {
                    if (Directory.Exists(@"E:\Images\InspectImage"))
                    {
                ...
                //try
                //{
                //    DirectoryInfo dir = new DirectoryInfo(@"E:\VisionDetect\InspectImage");
        ...
        private void  moveImage(string path , int  i)
        {
            ...
            {
            JudegPathExists:
                if (Directory.Exists(@"E:\VisionDetect\InspectImage"))
                {
                JudegPicUsed:
                    try
                    {
                        GetLatestFileTimeInfo(@"E:\VisionDetect\InspectImage\" + System.DateTime.Now.ToString("yyyy-MM-dd"), ".jpg");
                        string ImageNameOut = @"E:\Images\" + path + "\\" + pathSave[i] + "\\" + "OUT" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".jpg";
                        string ImageNameIn = @"E:\Images\" + path + "\\" + pathSave[i] + "\\" + "IN" + System.DateTime.Now.ToString("yyyyMMddHHmmss") + ".jpg";
                        if (!Directory.Exists(@"E:\Images\" + path + "\\" + pathSave[i]))
                        {
                            Directory.CreateDirectory(@"E:\Images\" + path + "\\" + pathSave[i]);
                        }
